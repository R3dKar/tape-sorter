...
Задание искусственной задержки работы ленты, а также максимальное количество элементов в ОЗУ при сортировке устанавливается в конфиге (пример есть в `config/config.toml`):
